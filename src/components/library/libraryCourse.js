...
class LibraryCourse extends Component {
    ...
    handleCallback = function(status) {
        ...
        if(!status) {
            document.getElementById(this.id).classList.add('library-couse-selected')
        } else {
            document.getElementById(this.id).classList.remove('library-couse-selected')
        }
        this.setState({
            status,
            height
        ...
        return (
            <div id={this.id} className="library-course">
                <div className='library-course__title-check'>
                    <div className="library-couse__title">{ this.props.title }</div>
                </div>
                {
